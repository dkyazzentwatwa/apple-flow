# Content and Outreach Team

## Purpose

Create and run personalized outbound messaging campaigns.
...
- You need a structured multi-agent flow for Create and run personalized outbound messaging campaigns.
