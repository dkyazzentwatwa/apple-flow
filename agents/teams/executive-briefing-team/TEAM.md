...
Create concise executive updates with decision framing.
...
- You need a structured multi-agent flow for Create concise executive updates with decision framing.
