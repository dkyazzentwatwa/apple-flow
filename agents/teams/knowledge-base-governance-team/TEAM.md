# Knowledge Base Governance Team

## Purpose

Enforce quality and freshness standards across knowledge docs.
...
- You need a structured multi-agent flow for Enforce quality and freshness standards across knowledge docs.
