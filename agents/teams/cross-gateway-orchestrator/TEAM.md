# Cross-Gateway Orchestrator

## Purpose

Coordinate workflows across iMessage, Mail, Notes, Reminders, and Calendar.
...
- You need a structured multi-agent flow for Coordinate workflows across iMessage, Mail, Notes, Reminders, and Calendar.
