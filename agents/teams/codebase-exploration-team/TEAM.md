# Codebase Exploration Team

## Purpose

Map unfamiliar codebases into searchable architecture knowledge.
...
- You need a structured multi-agent flow for Map unfamiliar codebases into searchable architecture knowledge.
