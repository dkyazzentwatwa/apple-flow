# Legal Contract Triage Team

## Purpose

Prioritize contract queues and risk review routing.
...
- You need a structured multi-agent flow for Prioritize contract queues and risk review routing.
