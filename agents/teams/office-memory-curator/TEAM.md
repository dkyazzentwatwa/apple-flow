# Office Memory Curator

## Purpose

Maintain high-signal durable memory across office artifacts.
...
- You need a structured multi-agent flow for Maintain high-signal durable memory across office artifacts.
