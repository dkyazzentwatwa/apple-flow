# Finance Close Assistant Team

## Purpose

Coordinate month-end close tasks and reconciliation checks.
...
- You need a structured multi-agent flow for Coordinate month-end close tasks and reconciliation checks.
