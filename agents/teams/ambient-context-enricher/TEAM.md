# Ambient Context Enricher

## Purpose

Continuously enrich memory from ambient Apple data.
...
- You need a structured multi-agent flow for Continuously enrich memory from ambient Apple data.
