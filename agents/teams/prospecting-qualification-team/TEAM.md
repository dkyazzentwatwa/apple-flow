# Prospecting and Qualification Team

## Purpose

Source leads and score fit against ICP criteria.
...
- You need a structured multi-agent flow for Source leads and score fit against ICP criteria.
