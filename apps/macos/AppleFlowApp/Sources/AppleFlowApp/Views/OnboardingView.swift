...
struct OnboardingView: View {
    ...
    private var progressStrip: some View {
        SectionCard("Setup Progress", subtitle: "Follow these milestones to complete onboarding") {
            HStack(spacing: 10) {
    ...
    private var coreConfigurationCard: some View {
        SectionCard("Core Configuration", subtitle: "Identity, workspace, and connector settings") {
    ...
    private var gatewaysCard: some View {
        SectionCard("Optional Gateways", subtitle: "Enable Apple app channels and customize resource names") {
            VStack(alignment: .leading, spacing: AppTheme.fieldSpacing) {
    ...
    private var agentOfficeCard: some View {
        SectionCard("Agent Office", subtitle: "Companion memory and personality source") {
            VStack(alignment: .leading, spacing: AppTheme.fieldSpacing) {
                HStack(spacing: 8) {
...
""")
    ...
    private var previewCard: some View {
        SectionCard("Generated .env Preview", subtitle: "Review before apply") {
            VStack(alignment: .leading, spacing: 10) {
                HStack {
    ...
    private func doctorCard(_ doctor: WizardDoctorResponse) -> some View {
        SectionCard("System Checks", subtitle: "Environment readiness before setup") {
            VStack(alignment: .leading, spacing: 10) {
