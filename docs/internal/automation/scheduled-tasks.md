# Claude Scheduled Tasks — Agent Office Edition

*2026 • Connectors: Gmail • Google Calendar • Web Search • Notion / Filesystem*

**How to Use This**

Each task is a ready-to-schedule Claude prompt. Copy it, set your schedule, and replace the `[BRACKETED]` placeholders with your specifics. All data storage uses the Agent Office folder structure — see SCAFFOLD.md for the canonical layout.

| Folder | Purpose | Used By |
|---|---|---|
| `10_daily/` | Daily notes, briefs, weekly reviews | Daily ops, weekly rhythm |
| `20_projects/` | Active project work, briefs | Dev tasks, project-specific |
| `30_areas/` | Ongoing responsibilities | Goals, learning, finance, areas |
| `40_resources/` | Reference material | Content, research, pipeline |
| `70_playbooks/` | SOPs | Business ops |
| `80_automation/` | Automation specs | Routine definitions |
| `90_logs/` | Audit trail | Log all runs |

*The prompts self-initialize: if a referenced file doesn't exist, the prompt creates it on first run. Start with the Daily Ops section and build from there.*

---

* 🧠 Executive Assistant — Daily Ops — 4 tasks

* 📅 Weekly Rhythm — 3 tasks

* 💰 Sales & Pipeline — 3 tasks

* 📣 Marketing & Content — 4 tasks

* 🔬 Research & Intelligence — 3 tasks

* 🌱 Personal Productivity — 3 tasks

* 🔧 Dev & Technical — 3 tasks

* ⚙️ Business Ops — 3 tasks

* 👥 Community & Creator — 2 tasks

---

## 🧠 Executive Assistant — Daily Ops

*The core EA stack. Run these daily and you'll never feel like things are slipping.*

| ☀️ Morning Briefing ⏰ 7:30 AM Daily | |
| :---- | ----- |
| 🔌 **Google Calendar • Gmail • Web Search • Filesystem** | |
| *Everything you need to walk into the day with clarity.* | |
| **📋 PROMPT** | |
...
| | |
| Save the full briefing to `10_daily/YYYY-MM-DD-morning.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ 5-section morning brief + saved to filesystem | |
| **💾 Saves to:** `10_daily/YYYY-MM-DD-morning.md` | |

| 📥 Email Triage ⏰ 9:00 AM Daily | |
| :---- | ----- |
| 🔌 **Gmail** | |
| *Zero inbox anxiety. Know exactly what needs you and what doesn't.* | |
| **📋 PROMPT** | |
...
| | |
| Save the full triage to `10_daily/YYYY-MM-DD-email.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Inbox categorized + draft replies for action items | |
| **💾 Saves to:** `10_daily/YYYY-MM-DD-email.md` | |

| 🔁 Follow-Up Sweep ⏰ 3:00 PM Daily | |
| :---- | ----- |
| 🔌 **Gmail • Filesystem** | |
| *Catches dropped balls before end of day. Revenue protection.* | |
| **📋 PROMPT** | |
| Scan for follow-up gaps. | |
| | |
| 1. GMAIL — Search sent mail from the last 10 days. Find emails with no reply received. | |
| Flag anything with no response after 3+ days. | |
| | |
...
| | |
| Sort oldest-first. | |
| Append today's sweep results to `10_daily/followups.md` | |
| Update `10_daily/YYYY-MM-DD.md` — remove any that got replies, add any new ones. | |
| | |
| End with: "X follow-ups need attention today." | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Prioritized follow-up list with draft messages, daily note updated | |
| **💾 Saves to:** `10_daily/followups.md` (appended) | |

| 🌙 EOD Wrap ⏰ 5:30 PM Daily | |
| :---- | ----- |
| 🔌 **Google Calendar • Gmail • Filesystem** | |
| *Close out the day clean and set up tomorrow before you close the laptop.* | |
| **📋 PROMPT** | |
...
| Save full wrap to `10_daily/YYYY-MM-DD-eod.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ EOD summary + tomorrow's task file pre-written | |
| **💾 Saves to:** `10_daily/YYYY-MM-DD-eod.md` | |

---

## 📅 Weekly Rhythm

*The weekly cadence that keeps you strategic instead of just reactive.*

| 🚀 Monday Kickoff ⏰ 8:00 AM Every Monday | |
| :---- | ----- |
| 🔌 **Google Calendar • Gmail • Filesystem** | |
| *Sets your weekly mission in under 2 minutes of reading.* | |
| **📋 PROMPT** | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Weekly mission brief + saved to filesystem | |
| **💾 Saves to:** `10_daily/YYYY-WW-kickoff.md` | |

| 📊 Friday Review ⏰ 4:00 PM Every Friday | |
| :---- | ----- |
| 🔌 **Google Calendar • Gmail • Filesystem** | |
| *Close the loop, learn from the week, pre-load Monday.* | |
| **📋 PROMPT** | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Weekly review saved + Monday task file pre-loaded | |
| **💾 Saves to:** `10_daily/YYYY-WW-review.md` | |

| 🧘 Weekly GTD Review ⏰ Every Sunday 6 PM | |
| :---- | ----- |
| 🔌 **Google Calendar • Gmail • Filesystem** | |
| *The review that actually clears your head before the week starts.* | |
| **📋 PROMPT** | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Full GTD review + someday list updated + priorities set | |
| **💾 Saves to:** `10_daily/YYYY-WW-gtd.md` | |

---

## 💰 Sales & Pipeline

*Keep revenue moving without a CRM.*

| 🎯 Lead Pipeline Review ⏰ Tue & Thu 10:00 AM | |
| :---- | ----- |
| 🔌 **Gmail • Filesystem** | |
| *Two touches a week keeps deals from going cold.* | |
| **📋 PROMPT** | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Pipeline reviewed, leads.md updated, 2 follow-up drafts | |
| **💾 Saves to:** `40_resources/pipeline/YYYY-MM-DD.md` | |

| 📬 Cold Outreach Batch ⏰ Every Tuesday 8 AM | |
| :---- | ----- |
| 🔌 **Gmail • Web Search • Filesystem** | |
| *Keeps top-of-funnel moving without the daily grind.* | |
| **📋 PROMPT** | |
...
| Log each prospect to `40_resources/pipeline/outreach-log.md` with: date, name, company, status=drafted | |
| If outreach-log.md doesn't exist, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ 5 personalized cold emails as Gmail drafts + outreach log updated | |
| **💾 Saves to:** `40_resources/pipeline/outreach-log.md` | |

| 📋 Proposal Status Audit ⏰ Every Friday 11 AM | |
| :---- | ----- |
| 🔌 **Gmail • Filesystem** | |
| *Make sure nothing you've sent has gone cold without you noticing.* | |
| **📋 PROMPT** | |
...
| 2. FILESYSTEM — Read `40_resources/pipeline/proposals.md` for any manually tracked proposals. | |
...
| Update `40_resources/pipeline/proposals.md` with current statuses. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Proposal audit + 2 follow-up drafts + proposals.md updated | |
| **💾 Saves to:** `40_resources/pipeline/proposals.md` | |

---

## 📣 Marketing & Content

*Stay visible and consistent without spending your whole day creating content.*

| ✍️ Weekly Content Ideas ⏰ Every Monday 9 AM | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *A week's worth of content angles in one shot.* | |
| **📋 PROMPT** | |
...
| | |
| Check `40_resources/content/used-ideas.md` — don't repeat anything from the last 30 days. | |
| If used-ideas.md doesn't exist, create it. | |
| | |
| Save ideas to `40_resources/content/ideas-YYYY-WW.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ 7 content ideas saved to filesystem | |
| **💾 Saves to:** `40_resources/content/ideas-YYYY-WW.md` | |

| 📱 LinkedIn Post Draft ⏰ Every Wednesday 8 AM | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *Keeps your feed alive on autopilot.* | |
| **📋 PROMPT** | |
...
| | |
| Append to `40_resources/content/linkedin-drafts.md` with today's date as a header. | |
| If linkedin-drafts.md doesn't exist, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ LinkedIn draft appended to filesystem | |
| **💾 Saves to:** `40_resources/content/linkedin-drafts.md` | |

| 📧 Newsletter Draft ⏰ Every Thursday 9 AM | |
| :---- | ----- |
| 🔌 **Web Search • Gmail • Filesystem** | |
| *Keeps your list warm every week without starting from scratch.* | |
| **📋 PROMPT** | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Full newsletter draft saved to filesystem | |
| **💾 Saves to:** `40_resources/content/newsletter-YYYY-MM-DD.md` | |

| 🔎 Competitor Pulse ⏰ Every Monday 10 AM | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *Know what the competition is doing in 5 minutes a week.* | |
| **📋 PROMPT** | |
...
| | |
| Read last week's file `40_resources/research/competitor-YYYY-WW.md` — note any new developments vs ongoing trends. | |
| If research/ folder doesn't exist, create it. | |
| | |
| Save to `40_resources/research/competitor-YYYY-WW.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Competitive intel brief saved to filesystem | |
| **💾 Saves to:** `40_resources/research/competitor-YYYY-WW.md` | |

---

## 🔬 Research & Intelligence

*Stay ahead without drowning in tabs and alerts.*

| 📡 Industry Signal Monitor ⏰ Every Tuesday 7 AM | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *5 signals. 5 minutes. Never be the last to know.* | |
| **📋 PROMPT** | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Weekly signal brief saved to filesystem | |
| **💾 Saves to:** `40_resources/research/signals-YYYY-MM-DD.md` | |

| 🧩 Deep Research Brief ⏰ On demand | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *Go deep on a topic when you have a real decision to make.* | |
| **📋 PROMPT** | |
...
| | |
| Save to `40_resources/research/deep/TOPIC-YYYY-MM-DD.md` | |
| If deep/ folder doesn't exist, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Deep research brief saved to filesystem | |
| **💾 Saves to:** `40_resources/research/deep/TOPIC-YYYY-MM-DD.md` | |
...
| Read `10_daily/meetings/` for any prior meeting notes. | |
| If meetings/ folder doesn't exist, create it. | |
| | |
| Save to `10_daily/meetings/YYYY-MM-DD-PERSON.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Pre-meeting dossier with talking points saved to filesystem | |
| **💾 Saves to:** `10_daily/meetings/YYYY-MM-DD-PERSON.md` | |

---

## 🌱 Personal Productivity

*Run your own operating system without needing a tool for every habit.*

| 📚 Learning Digest ⏰ Every Wednesday 7 PM | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *Stay sharp without drowning in bookmarks you'll never read.* | |
| **📋 PROMPT** | |
...
| | |
| Check `30_areas/learning/queue.md` — skip anything already there. | |
| If queue.md doesn't exist, create it in 30_areas/learning/. | |
| | |
...
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Learning digest saved, queue.md updated | |
| **💾 Saves to:** `30_areas/learning/YYYY-WW.md` | |

| ⚡ Idea Capture & Triage ⏰ Every Sunday 8 AM | |
| :---- | ----- |
| 🔌 **Filesystem • Gmail** | |
| *Stop letting good ideas die in your drafts and notes.* | |
| **📋 PROMPT** | |
...
| | |
| Save triage report to `40_resources/ideas/triaged-YYYY-MM-DD.md` | |
| If ideas/ folder doesn't exist, create it in 40_resources/. | |
| End with: "X ideas processed. X worth pursuing." | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Ideas triaged, inbox cleared, build-now items added to task list | |
| **💾 Saves to:** `40_resources/ideas/triaged-YYYY-MM-DD.md` | |

| 🎯 Monthly Goal Check-In ⏰ 1st of every month | |
| :---- | ----- |
| 🔌 **Filesystem • Gmail • Web Search** | |
| *Keep long-term goals from being buried under daily noise.* | |
| **📋 PROMPT** | |
...
| | |
| Update `30_areas/goals/active.md` with current status. | |
| Save this check-in to `30_areas/goals/YYYY-MM.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Monthly goal check-in saved, goals/active.md updated | |
| **💾 Saves to:** `30_areas/goals/YYYY-MM.md` | |

---

## 🔧 Dev & Technical

*Automate the dev-operator overhead without leaving your workflow.*

| 📝 Changelog Generator ⏰ Every Friday 3 PM | |
| :---- | ----- |
| 🔌 **Filesystem** | |
| *Turn raw commit notes into a readable changelog automatically.* | |
| **📋 PROMPT** | |
...
| | |
| Append to `20_projects/[project]/CHANGELOG.md` | |
| If CHANGELOG.md doesn't exist, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| | |
| [PASTE COMMITS OR NOTES HERE IF NO LOG FILE] | |
| ✅ Formatted changelog entry appended to project CHANGELOG.md | |
| **💾 Saves to:** `20_projects/[project]/CHANGELOG.md` | |

| 🔒 Monthly Tech Health Check ⏰ 1st of every month | |
| :---- | ----- |
| 🔌 **Filesystem • Web Search** | |
| *Keeps your projects from quietly rotting between active sprints.* | |
| **📋 PROMPT** | |
...
| □ Dependency updates needed? (check `20_projects/[name]/package.json` or `requirements.txt` age) | |
| □ Any open issues or PRs sitting more than 7 days? | |
| □ Secrets or API keys expiring soon? (check `20_projects/[name]/.env.example` for references) | |
...
| Save to `30_areas/tech/health-YYYY-MM.md` | |
| If tech/ folder doesn't exist in 30_areas/, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Tech health checklist per project saved to filesystem | |
| **💾 Saves to:** `30_areas/tech/health-YYYY-MM.md` | |

| 🧠 Architecture Decision Log ⏰ On demand | |
| :---- | ----- |
| 🔌 **Filesystem** | |
| *Capture the WHY before you forget it — future you will thank you.* | |
| **📋 PROMPT** | |
...
| [3 months from today] | |
| | |
| Append an entry to `70_playbooks/adr/index.md`: date | title | status | |
| If index.md doesn't exist, create the adr/ folder in 70_playbooks/. | |
| Save full ADR to `70_playbooks/adr/YYYY-MM-DD-title-slug.md` | |
| Append a summary entry to `90_logs/automation-log.md` | |
| | |
| [DESCRIBE YOUR DECISION AND CONTEXT HERE] | |
| ✅ ADR saved to filesystem + index.md updated | |
| **💾 Saves to:** `70_playbooks/adr/YYYY-MM-DD-title-slug.md` | |

---

## ⚙️ Business Ops

*Keep the business running without building a bureaucracy.*

| 💵 Monthly Revenue Snapshot ⏰ 1st of every month | |
| :---- | ----- |
| 🔌 **Gmail • Filesystem** | |
| *Know your numbers in 5 minutes without a finance stack.* | |
| **📋 PROMPT** | |
...
| Update `30_areas/finance/revenue-log.md` with this month's summary line. | |
| If revenue-log.md doesn't exist, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Monthly revenue snapshot saved + revenue-log.md updated | |
| **💾 Saves to:** `30_areas/finance/YYYY-MM.md` | |

| 📋 SOP Builder ⏰ On demand | |
| :---- | ----- |
| 🔌 **Filesystem** | |
| *Turn your brain into a document so you can delegate or automate anything.* | |
| **📋 PROMPT** | |
...
| Append an entry to `70_playbooks/index.md`: date | task name | owner | frequency | |
| If index.md doesn't exist, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| | |
| [DESCRIBE YOUR TASK/PROCESS HERE] | |
| ✅ SOP saved to filesystem + index.md updated | |
| **💾 Saves to:** `70_playbooks/TASK-SLUG.md` | |

| 📅 Quarterly Business Review ⏰ First week of each quarter | |
| :---- | ----- |
| 🔌 **Gmail • Filesystem • Web Search** | |
| *Zoom out every 90 days and make sure you're building the right thing.* | |
| **📋 PROMPT** | |
...
| | |
| Save to `30_areas/ops/qbr-YYYY-QN.md` | |
| If ops/ folder doesn't exist in 30_areas/, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ Quarterly review saved to filesystem | |
| **💾 Saves to:** `30_areas/ops/qbr-YYYY-QN.md` | |

---

## 👥 Community & Creator

*Grow and nurture an audience without it consuming your whole week.*

| 💬 Community Engagement Prompts ⏰ Every Monday 8 AM | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *Five discussion sparks every week — never post into the void.* | |
| **📋 PROMPT** | |
...
| | |
| Check `40_resources/community/used-prompts.md` — don't repeat recent ones. | |
| If used-prompts.md doesn't exist, create it in 40_resources/community/. | |
| Append used prompts to `40_resources/community/used-prompts.md` after choosing. | |
| Save to `40_resources/community/prompts-YYYY-WW.md` | |
| If community/ folder doesn't exist in 40_resources/, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| ✅ 5 engagement prompts saved, used-prompts.md updated | |
| **💾 Saves to:** `40_resources/community/prompts-YYYY-WW.md` | |

| 📊 Community Health Report ⏰ 1st of every month | |
| :---- | ----- |
| 🔌 **Web Search • Filesystem** | |
| *One clear read on whether your community is growing or drifting.* | |
| **📋 PROMPT** | |
...
| | |
| Compare to `40_resources/community/health-YYYY-MM.md` (last month) for trend context. | |
| Save to `40_resources/community/health-YYYY-MM.md` | |
| If community/ folder doesn't exist in 40_resources/, create it. | |
| Append a summary entry to `90_logs/automation-log.md` | |
| | |
| [PASTE YOUR METRICS HERE] | |
| ✅ Community health report saved to filesystem | |
| **💾 Saves to:** `40_resources/community/health-YYYY-MM.md` | |

---

**Tip: Start with 3 tasks, not 30.**
